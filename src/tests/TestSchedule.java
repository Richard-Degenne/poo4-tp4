...
public class TestSchedule {
    ...
    public static void main(String[] args) {
        ...
        /* REMARK:
         * For some reason, `wjd.find` does not correctly assign `tasks` to `machines`,
         * so the printed output is wrong even though the data is correct in the
         * persistence unit.
         */
        System.out.println(wjd.find(w1.getId()));
    }
}
